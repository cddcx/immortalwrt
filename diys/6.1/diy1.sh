...
sed -i 's/automount/autocore default-settings-chn ipset luci luci-compat luci-app-udpxy luci-app-upnp luci-app-v2raya luci-app-passwall2 luci-app-openclash/g' target/linux/x86/Makefile
