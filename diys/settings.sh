...
sed -i 's/automount/default-settings-chn ipset luci luci-compat luci-app-filetransfer luci-app-homeproxy luci-app-passwall2 luci-app-ttyd luci-app-udpxy luci-app-upnp/g' target/linux/x86/Makefile
