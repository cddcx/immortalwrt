...
sed -i 's/automount/autocore default-settings-chn ipset luci luci-compat luci-app-filetransfer luci-app-openclash luci-app-passwall luci-app-passwall2 luci-app-ttyd luci-app-udpxy luci-app-upnp luci-app-v2raya/g' target/linux/x86/Makefile
